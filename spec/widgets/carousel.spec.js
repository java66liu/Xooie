  ...
  describe('Carousel', function () {
    ...
    describe('Roles', function () {
      ...
      it('defines a role content', function () {
        expect(typeof this.carousel.content).toBe('function');
      });

      it('adds the contentClass to the content', function () {
        expect(this.carousel.content().hasClass(this.carousel.contentClass())).toBe(true);
      });
    });
      ...
      describe('item', function () {
        ...
        describe('the direction is goto', function () {
          ...
          beforeEach(function () {
            ...
            spyOn(this.carousel, 'content').andReturn(content);
          });
